...
user4 = Teacher.create(first_name:'Jennifer', last_name:'Wilson', email: 'Jennifer@gmail.com', password:'123456', address:'Shikun Dan', phone_number:'90569838', remote_picture_url:'https://cdn.pixabay.com/photo/2016/03/26/12/10/granny-1280445_1280.jpg', bio:"Still at school Watershed. In 1987 he joined Signal Radio in Stoke-on-Trent, where he presented the Drivetime show, still under his real name, where his vocal style was compared by many to.
He went on to appear on Cardiff's Red Dragon FM, followed by a presented the late night 10pm – 2am show.",latitude: 32.180586, longitude: 34.893692)
...
He went on to appear on Cardiff's Red Dragon FM, followed by a presented the late night 10pm – 2am show.", latitude: 32.057134,longitude: 34.76411)
...
user13 = Teacher.create(first_name:'Alice', last_name:'Nelson', email: 'alice@gmail.com', password:'123456', address:"Yishkon St 36, Tel Aviv-Yafo", phone_number:'234567654', remote_picture_url:'https://img.rawpixel.com/s3fs-private/rawpixel_images/website_content/345-pai3902-jj-r2-01.jpg?auto=format&bg=F4F4F3&con=3&cs=srgb&dpr=1&fm=jpg&ixlib=php-1.1.0&mark=rawpixel-watermark.png&markalpha=90&markpad=13&markscale=10&markx=25&q=75&usm=15&vib=3&w=1800&s=054820350b49b2b546aed9130a831f69', bio:"Still at school Watershed. In 1987 he joined Signal Radio in Stoke-on-Trent, where he presented the Drivetime show, still under his real name, where his vocal style was compared by many to.
He went on to appear on Cardiff's Red Dragon FM, followed by a presented the late night 10pm – 2am show.", latitude: 32.068586,longitude: 34.768233)
